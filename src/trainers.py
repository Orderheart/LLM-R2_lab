...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        def batcher(params, batch):
            ...
            batch = eval_collator(sentences).to(self.args.device)  # 将 batch 移动到 GPU 设备
            with torch.no_grad():
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        ...
        assert model_to_save is self.model, "internal model should be a reference to self.model"
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (step + 1) % self.args.gradient_accumulation_steps == 0 or (
                    ...
                    if torch.cuda.is_available():
                        ...
                        # 如果没有CUDA环境，这里可能需要额外的处理，例如使用CPU训练
                        self.optimizer.step()
